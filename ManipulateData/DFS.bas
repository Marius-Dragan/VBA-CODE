...
Dim i As Long
    i = 0
    questionBoxPopUp = MsgBox("Are you sure you want to edit this worksheet?", vbQuestion + vbYesNo + vbDefaultButton1, "Edit DFS details flow?")
...
On Error GoTo ErrorHandler
    ...
    currentProgressBar.SetStatus "Editing DFS Detail Flow... Processing text to column"
...
Application.ScreenUpdating = False
    ...
    Selection.TextToColumns Destination:=ActiveCell, DataType:=xlDelimited, _
        ...
        currentProgressBar.SetValue i
        currentProgressBar.SetStatus "Deselecting cells..."
        
        Range("A1").Activate
        
        Call SmartUtilities.TrimCellsArrayMethodUsedRange 'dependancy to add SmartUtilities
        i = i + 25
        currentProgressBar.SetValue i
        currentProgressBar.SetStatus "Trimming all excess space in all used cells..."
        
        Call SmartUtilities.TrimCellsArrayMethodUsedRange
        
        i = i + 25
        currentProgressBar.SetValue i
        currentProgressBar.SetStatus "Changing print out properties..."
        
        changeProperties WS

        i = i + 25
        currentProgressBar.SetValue i
        currentProgressBar.SetStatus "Processing autosum and saving to folder path if any set..."
...
'
' Working version with no errors no longer in use
...
'Set fso = New Scripting.FileSystemObject
    ...
    newFolderPath = Environ("UserProfile") & "\Desktop\Marius\DELIVERIES\DAILY REPORT-In Shipment\"
        ...
        End If
           ...
           saveDetails = newFolderPath & myFileName & " - Next Delivery " & dateFormat & ".xlsx"
