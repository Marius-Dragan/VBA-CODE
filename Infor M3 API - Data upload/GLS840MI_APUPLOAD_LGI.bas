Attribute VB_Name = "GLS840MI_APUPLOAD_LGI"
...
'
    ...
    If Range("L4").Value = "Production" Then
        HostURL = "https://yourdomain.cloud.infor.com:12345" 'Prod
    Else
        HostURL = "https://yourdomaindev.cloud.infor.com:12345" 'Dev
    End If


    interface = "APUPLOAD-LGI"
    ...
    'Company = "100"
    company = Range("L6").Value
    APID = UCase(Range("I6").Cells.Value) 'username
    ...
    HeaderDesc = "Invoice upload " + ProcessDate + UserId
     ...
     InvoiceNo = rng.Cells(i, 2).Value  'C
    ...
    MsgBox "Process completed!", vbOKOnly, "M3"
    End If
    LastInvoiceNo = ""
End Sub
...
Public Sub FormatI1()
   lineno = lineno + 1
       ...
       AIT1 = "21020     "   'if AP account is hard coded
       'AIT4 = Left(Format(Dim4) + "          ", 10)
       'AIT5 = Left(Format(Dim5) + "          ", 10)
       'AIT6 = Left(Format(Dim6) + "          ", 10)
       AIT6 = "Z99       "   'if AP account is hard coded
...
Public Sub FormatI2()
     lineno = lineno + 1
       ...
       SINO = Left(Format(CStr(InvoiceNo), ">") + "                        ", 24)
