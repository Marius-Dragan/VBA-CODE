Attribute VB_Name = "MNS150MI_Users"
Option Explicit
Sub UploadLineMNS150MIUsers()
...
Do While (StartRow <= EndRow)
    ...
    sURL = sURL & "&NAME=" & xSheet.Cells(StartRow, 4)
    sURL = sURL & "&DFCO=" & xSheet.Cells(StartRow, 5)

    If xSheet.Cells(StartRow, 6).Value <> "" Then
    sURL = sURL & "&DFDI=" & xSheet.Cells(StartRow, 6)
    End If

    If xSheet.Cells(StartRow, 7).Value <> "" Then
    sURL = sURL & "&USTP=" & xSheet.Cells(StartRow, 7)
    End If

    If xSheet.Cells(StartRow, 8).Value <> "" Then
    sURL = sURL & "&USIG=" & xSheet.Cells(StartRow, 8)
    End If

    If xSheet.Cells(StartRow, 9).Value <> "" Then
    sURL = sURL & "&ADK1=" & xSheet.Cells(StartRow, 9)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&DCFM=" & xSheet.Cells(StartRow, 10)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&DTFM=" & xSheet.Cells(StartRow, 11)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&TIZO=" & xSheet.Cells(StartRow, 12)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&LANC=" & xSheet.Cells(StartRow, 13)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&FACI=" & xSheet.Cells(StartRow, 14)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&WHLO=" & xSheet.Cells(StartRow, 15)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&MNVR=" & xSheet.Cells(StartRow, 16)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&DFMN=" & xSheet.Cells(StartRow, 17)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&EQAL=" & xSheet.Cells(StartRow, 18)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&USTA=" & xSheet.Cells(StartRow, 19)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&FRF6=" & xSheet.Cells(StartRow, 20)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&FRF7=" & xSheet.Cells(StartRow, 21)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&FRF8=" & xSheet.Cells(StartRow, 22)
    End If

    If xSheet.Cells(StartRow, 10).Value <> "" Then
    sURL = sURL & "&EUID=" & xSheet.Cells(StartRow, 23)
    End If
